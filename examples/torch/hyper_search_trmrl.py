...
init_std_list = [0.5, 1.0]
decay_epoch_list = [100, 250, 500, 750]


def trmrl_cmd(nheads_dmodel, layers, dropout_rate, wm_length, em_length,\
    ...
    cmd = "./transformer_ppo_halfcheetah.py " + \
...
def run_search(gpu_id):
    ...
    while True:
        ...
        for _ in range(MAX_RUNNING_PROCESSES - len(process_list)):
            ...
            cmd = trmrl_cmd(random.choice(heads_dmodel), random.choice(encoder_decoder_layers), \
